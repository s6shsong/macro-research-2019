...
Pe=0.05;                  % Energy price(data)

% Government parameters
tauL=0.45;                  % Labor tax rate(Data)
G = 0.44;                   % government spending(normalize)
...
disp('      K0         E0      N0       w         r         carbon taxation     Y     K/Y    h    Gini');
disp([K0, E0, N0, w0, r0,tauC, Y, K0/Y, h, gini_index]);
